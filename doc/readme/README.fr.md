...
AIdea s'adresse aux chercheurs qui souhaitent conserver dans Zotero la lecture d'articles, les questions de suivi, l'extraction de passages, l'organisation des notes et la traduction intégrale. Le plugin ajoute un espace de travail IA cohérent et durable à la vue Bibliothèque ainsi qu'au lecteur PDF, afin d'éviter les allers-retours entre Zotero et plusieurs outils externes.

## Capacités principales

- **Dialogue IA dans le panneau latéral** de la vue Bibliothèque et du lecteur PDF
- **Contexte centré sur l'article** à partir de texte PDF sélectionné, de captures, de figures et de pièces jointes
...
- **Traduction par sélection** dans les lecteurs PDF et EPUB, avec détection automatique du format, cache local de démarrage à froid et ajout possible aux notes Zotero
